...
<body class="hold-transition login-page" style="background-image: url('../assets/frontend/img/banner/common-banner.jpg');">
<div class="login-box">
    ...
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url()?>admin/login/authenticate" name="loginForm" id="loginForm" method="post">
        <div class="input-group mb-3">
          <input type="text" name="username" id="username"  value="<?php echo set_value('username'); ?>"  class="form-control <?php echo (form_error('username') != "" ) ? 'is-invalid' : ''; ?> " placeholder="Username">
